...
def mes(nome_do_mês, dias, dia_inicial = 0, linha_inicial = 0, coluna_inicial = 0):
    diaAtual = 1
...
if __name__ == '__main__':
    ...
    mes('Janeiro', dias=30)
    mes('Fevereiro', dias=31,  linha_inicial=27)
    #mes('Março', 31,  linha_inicial=54)
    #mes('Abril', 31,  linha_inicial=81)
